        ...
        <nav className="bg-color border-bottom text-white">
            <div className="container d-flex flex-wrap">
                ...
                <ul className="nav me-auto mt-1">
                    ...
                    <li className="nav-item mt-2">
                        <p className="text-white input-group mb-3">
                            <input type="text" id="search" className="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="button-addon2" />
                ...
                <ul className="nav mt-2">
                    ...
                    <li className="nav-item mt-2">
                        <p className="text-white">
                            <button type="button" className="btn btn-sm rounded-circle btn-dark mx-1">
