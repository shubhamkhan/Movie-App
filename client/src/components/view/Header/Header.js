...
const Header = () => {
    return (
        <nav className="app-bg-primary app-text-secondary">
            <div className="container d-flex flex-wrap">
                ...
                <ul className="nav me-auto mt-1">
                    ...
                    <li className="nav-item mt-2">
                        <p className="nav-link app-text-secondary">Home</p>
                    </li>
                    </Link>
                    <Link to="/about">
                    <li className="nav-item mt-2">
                        <p className="nav-link app-text-secondary">About</p>
                    </li>
                    </Link>
                    <li className="nav-item mt-2">
                        <p className="app-text-secondary input-group mb-3">
                ...
                <ul className="nav mt-2">
                    ...
                    <li className="nav-item mt-2">
                        <p className="app-text-secondary">
                            <button type="button" className="btn btn-sm btn-dark rounded-circle mx-1">
